...
import { Calendar, Clock, Store, ChevronRight, DollarSign } from 'lucide-react'
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs text-muted-foreground">
                      ...
                      <div className="flex items-center gap-1 truncate">
                        <Store className="h-3 w-3 shrink-0 text-[rgb(var(--brand-secondary))]/60 dark:text-[rgb(var(--brand-primary))]/60" />
                        <span className="truncate">{appointment.seller}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <DollarSign className="h-3 w-3 text-[rgb(var(--brand-secondary))]/60 dark:text-[rgb(var(--brand-primary))]/60" />
