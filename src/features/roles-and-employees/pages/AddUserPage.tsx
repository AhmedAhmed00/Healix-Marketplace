                                ...
                                return (
                                  <div
                                    ...
                                    className={cn(
                                      ...
                                      isRolePermission && 'bg-[#1974BB]/5 dark:bg-[#3BC1CF]/5 border border-[#1974BB]/20 dark:border-[#3BC1CF]/20'
                                    )}
                                  >
                                    <FormCheckbox
                                    ...
                                    />
                                    {isRolePermission && (
                                      <span className="text-xs text-[#1974BB] dark:text-[#3BC1CF] font-medium ml-auto">
                                        From Role
                                      </span>
                                    )}
                                  </div>
