            ...
            events.map(event => (
              <div
                ...
                className={cn(
                  ...
                  event.color === "purple" && "bg-purple-600 dark:bg-purple-500",
                  event.color === "orange" && "bg-orange-600 dark:bg-orange-500",
            ...
            <>
              <div
                className={cn(
                  ...
                  events[0].color === "purple" && "bg-purple-600 dark:bg-purple-500",
                  events[0].color === "orange" && "bg-orange-600 dark:bg-orange-500",
