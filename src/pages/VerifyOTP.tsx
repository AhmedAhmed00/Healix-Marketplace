...
export default function VerifyOTP() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 p-4">
      ...
      <Card className="w-full pb-12 max-w-md relative z-10 shadow-2xl border-t-4 border-t-[#3BC1CF]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <span className="text-muted-foreground">
                {timeLeft > 0 ? (
                  <>Code expires in: <span className="font-semibold text-[#3BC1CF]">{formatTime(timeLeft)}</span></>
                ) : (
              ...
              <button
                ...
                className="text-[#3BC1CF] hover:text-[#1974BB] hover:underline transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Resend OTP
              </button>
            </div>
