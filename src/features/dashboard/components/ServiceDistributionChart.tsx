...
const servicesData = [
  { name: 'General Consultation', value: 145, color: '#3BC1CF' },
  { name: 'Cardiology', value: 98, color: '#1974BB' },
...
export function ServiceDistributionChart() {
  return (
    <Card className="border-t-4 border-t-[#3BC1CF]">
      <CardHeader>
        <CardTitle className="text-[#1974BB] dark:text-[#3BC1CF]">Service Distribution</CardTitle>
