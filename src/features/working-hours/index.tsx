...
export default function WorkingHoursPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* Success Message */}
      {showSuccess && (
        <Alert className="border-[#3BC1CF]/30 bg-[#3BC1CF]/10 dark:bg-[#3BC1CF]/5 dark:border-[#3BC1CF]/20">
          <div className="p-1 rounded-md bg-[#3BC1CF]/20">
            <AlertCircle className="h-4 w-4 text-[#1974BB] dark:text-[#3BC1CF]" />
          </div>
          <AlertDescription className="text-[#1974BB] dark:text-[#3BC1CF]">
      ...
      {/* Info Alert */}
      <Alert className="border-[#3BC1CF]/20 bg-[#3BC1CF]/5">
        <div className="p-1 rounded-md bg-[#3BC1CF]/10">
          <AlertCircle className="h-4 w-4 text-[#1974BB] dark:text-[#3BC1CF]" />
        </div>
