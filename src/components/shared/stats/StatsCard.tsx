...
const colorConfig: Record<ColorVariant, {
  ...
  purple: {
    gradient: GRADIENTS.purple.gradient,
    bgGradient: GRADIENTS.purple.bgGradient,
    iconBg: `bg-linear-to-br ${GRADIENTS.purple.gradient}`,
    iconColor: 'text-white',
    border: 'border-l-purple-500',
    shadow: 'hover:shadow-purple-500/20',
    text: GRADIENTS.purple.gradient,
  },
  orange: {
