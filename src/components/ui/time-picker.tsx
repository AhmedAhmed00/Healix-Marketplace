  ...
  return (
    <div className={cn("flex items-center gap-2", className)} id={id}>
      <div className="relative flex items-center gap-1">
        <div className="absolute left-3 top-1/2 -translate-y-1/2 p-0.5 rounded bg-[#3BC1CF]/10 pointer-events-none z-10">
          <Clock className="w-3.5 h-3.5 text-[#1974BB] dark:text-[#3BC1CF]" />
        </div>
