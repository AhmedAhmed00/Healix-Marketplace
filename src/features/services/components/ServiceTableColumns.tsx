...
export const serviceColumns: ColumnDef<Service>[] = [
  {
    ...
    cell: ({ row }) => {
      return (
        <div className="font-medium text-[#1974BB]">
          {row.getValue('name')}
        </div>
      )
    },
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <Badge variant="outline" className="border-[#3BC1CF] text-[#1974BB]">
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className="font-semibold text-[#3BC1CF]">{formatted}</div>
    },
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge
          ...
          className={
            status === 'active'
              ? 'bg-linear-to-r from-[#3BC1CF] to-[#1974BB] text-white'
              : ''
          }
        >
          {status}
