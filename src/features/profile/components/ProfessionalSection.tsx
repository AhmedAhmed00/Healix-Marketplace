    ...
    <Card className="relative overflow-hidden border-t-4 border-t-[rgb(var(--brand-primary))] shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-start gap-4 p-4 rounded-xl bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-800/50 dark:to-slate-900/50 border border-slate-200 dark:border-slate-700">
          <div className="shrink-0 w-10 h-10 rounded-lg bg-linear-to-br from-[#3BC1CF] to-[#1974BB] shadow-md flex items-center justify-center">
          ...
          <Badge className="bg-[#3BC1CF]/10 text-[#1974BB] dark:bg-[#3BC1CF]/20 dark:text-[#3BC1CF] border-[#3BC1CF]/30 dark:border-[#3BC1CF]/40">
        ...
        {/* Years of Experience */}
        <div className="flex items-start gap-4 p-4 rounded-xl bg-linear-to-br from-[#E0F4F7] to-[#D4EEF8] dark:from-[#0F2730]/30 dark:to-[#0A1C28]/30 border border-[#3BC1CF]/20 dark:border-[#3BC1CF]/30">
          <div className="shrink-0 w-10 h-10 rounded-lg bg-linear-to-br from-[#1974BB] to-[#3BC1CF] shadow-md flex items-center justify-center">
