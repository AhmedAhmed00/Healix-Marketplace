...
import { LayoutGrid, Clock, CheckCircle, Package, Truck, CircleCheckBig, XCircle } from 'lucide-react'
import { TAB_CONFIGS } from '../constants/order-status'
...
export function OrdersTabs({
  ...
  return (
    <div>
      <Tabs value={activeTab} onValueChange={(value) => onTabChange(value as OrderStatus | 'all')}>
